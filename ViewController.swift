...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.x = self.view.frame.width / 2
        self.y = self.view.frame.height / 2
        
        _ = Timer.scheduledTimer(timeInterval: 60, target: self, selector: #selector(self.updateView), userInfo: nil, repeats: true)
